...
The following is an example referring to output parameter 'number' from xref:README.adoc#authentication-methods[create] step as input in poll-for-approval step:
